...
import { activateWorkerPolicy, validateWorkerPolicyProjection } from './worker-policy-store.mjs';
...
if (
  ...
  throw new Error(
    'usage: node scripts/activate-worker-policy.mjs --config CONFIG --policy JSON --expected REVISION|none --actor NAME --reason TEXT --remote yes|no --apply yes|no',
  );
}
