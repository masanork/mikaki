...
import { validatePublicRecord } from './recipient-key-admin.mjs';
...
function options(args) {
  ...
  if (
    ...
    throw new Error(
      'usage: node scripts/recipient-secret-admin.mjs --seed FILE --public FILE --store-id STORE_ID --config CONFIG --apply yes|no',
    );
  }
  return parsed;
}
