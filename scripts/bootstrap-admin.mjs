...
import { issueBootstrapInvite } from './enrollment-store.mjs';
...
if (
  ...
  throw new Error(
    'usage: node scripts/bootstrap-admin.mjs --config CONFIG --remote yes|no --actor NAME --reason TEXT --output FILE --apply yes|no',
  );
}
