...
import { deliver, logoutEvent } from './logout-delivery.mjs';
import {
  initSync,
  register,
  authenticate,
...
const body = (req, kind) => readBody(req, kind, valid_json);
...
async function login(db, req, id, csrf) {
...
async function issueCode(db, l, session, prefix = [], newSecret) {
