...
root_name, inter_name = name('Sakimori test root'), name('Sakimori test intermediate')
packed_name = x509.Name([x509.NameAttribute(NameOID.COUNTRY_NAME,'US'),x509.NameAttribute(NameOID.ORGANIZATION_NAME,'Sakimori tests'),x509.NameAttribute(NameOID.ORGANIZATIONAL_UNIT_NAME,'Authenticator Attestation'),x509.NameAttribute(NameOID.COMMON_NAME,'Independent batch')])
