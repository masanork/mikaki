...
Snapshot: `2026-09-24` / commit `ccd96a6`
...
| npm development | 14 | `@inlang/paraglide-js`, `@inlang/plugin-message-format`, `@playwright/test`, `@sveltejs/vite-plugin-svelte`, `@types/node`, `@typescript/native`, `esbuild`, `prettier`, `prettier-plugin-svelte`, `smol-toml`, `svelte-check`, `typescript`, `vite`, `wrangler` |
